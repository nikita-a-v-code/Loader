...
export const EXCEL_FIELD_RULES = {
  ...
  // "Номер трансформаторной подстанции" - валидируется только по списку в requiredFromList()
};
...
export const RIM_MODELS_REQUIRING_COMMUNICATOR = ["РиМ 189.26", "РиМ 289.24", "РиМ 489.24", "РиМ 489.26", "РиМ 489.30"];
